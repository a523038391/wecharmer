...
class PurchaseOrder:
    ...
    def  create_purchaseorder_link(self, cookies, shopId, warehouseId, operateDivisionId, purchaserId, product_code,supplierId,companyId):
        """
        创建采购单链路
        :param companyId:财务公司抬头id
        :param supplierId:供应商id
...
if __name__ == '__main__':
    ...
    # 创建常规采购单
    PurchaseOrder().create_purchaseorder_link(cookies, 161, 15, 5, 303, "A5-181",6,2)
